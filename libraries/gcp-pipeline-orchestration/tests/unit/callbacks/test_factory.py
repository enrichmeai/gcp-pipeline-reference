...
from gcp_pipeline_orchestration.callbacks import (
    ErrorHandlerConfig,
    create_error_handler,
)
from gcp_pipeline_orchestration.callbacks.factory import ErrorHandler
...
class TestErrorHandler(unittest.TestCase):
    ...
    @patch('gcp_pipeline_orchestration.callbacks.factory.publish_to_dlq')
    ...
    @patch('gcp_pipeline_orchestration.callbacks.factory.on_failure_callback')
