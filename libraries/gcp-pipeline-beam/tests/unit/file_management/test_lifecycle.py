...
from gcp_pipeline_beam.file_management.lifecycle import FileLifecycleManager
from gcp_pipeline_beam.file_management.types import ArchiveResult, ArchiveStatus


class TestFileLifecycleManagerInit:
    """Test FileLifecycleManager initialization."""

    @patch('gcp_pipeline_beam.file_management.lifecycle.storage.Client')
    @patch('gcp_pipeline_beam.file_management.lifecycle.FileValidator')
    @patch('gcp_pipeline_beam.file_management.lifecycle.FileArchiver')
    @patch('gcp_pipeline_beam.file_management.lifecycle.FileMetadataExtractor')
    ...
    def test_init_with_all_optional_params(
        ...
        from gcp_pipeline_beam.file_management.policy import ArchivePolicyEngine
...
class TestValidateFile:
    ...
    def manager_with_mocks(self):
        ...
        with patch('gcp_pipeline_beam.file_management.lifecycle.storage.Client'), \
             patch('gcp_pipeline_beam.file_management.lifecycle.FileValidator') as mock_validator_cls, \
             patch('gcp_pipeline_beam.file_management.lifecycle.FileArchiver'), \
             patch('gcp_pipeline_beam.file_management.lifecycle.FileMetadataExtractor'):
...
class TestArchiveFile:
    ...
    def manager_with_mocks(self, fixed_datetime):
        ...
        with patch('gcp_pipeline_beam.file_management.lifecycle.storage.Client'), \
             patch('gcp_pipeline_beam.file_management.lifecycle.FileValidator'), \
             patch('gcp_pipeline_beam.file_management.lifecycle.FileArchiver') as mock_archiver_cls, \
             patch('gcp_pipeline_beam.file_management.lifecycle.FileMetadataExtractor'):
...
class TestHandleErrorFile:
    ...
    def manager_with_mocks(self):
        ...
        with patch('gcp_pipeline_beam.file_management.lifecycle.storage.Client') as mock_storage, \
             patch('gcp_pipeline_beam.file_management.lifecycle.FileValidator'), \
             patch('gcp_pipeline_beam.file_management.lifecycle.FileArchiver'), \
             patch('gcp_pipeline_beam.file_management.lifecycle.FileMetadataExtractor'):
...
class TestCompleteLifecycle:
    ...
    def manager_with_full_mocks(self, fixed_datetime):
        ...
        with patch('gcp_pipeline_beam.file_management.lifecycle.storage.Client') as mock_storage, \
             patch('gcp_pipeline_beam.file_management.lifecycle.FileValidator') as mock_validator_cls, \
             patch('gcp_pipeline_beam.file_management.lifecycle.FileArchiver') as mock_archiver_cls, \
             patch('gcp_pipeline_beam.file_management.lifecycle.FileMetadataExtractor') as mock_extractor_cls:
