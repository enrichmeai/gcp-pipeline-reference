...
from gcp_pipeline_beam.file_management.metadata import FileMetadata, FileMetadataExtractor
...
class TestFileMetadataExtractorInit:
    ...
    @patch('gcp_pipeline_beam.file_management.metadata.storage.Client')
...
class TestGetFileSize:
    ...
    def extractor_with_mocks(self):
        ...
        with patch('gcp_pipeline_beam.file_management.metadata.storage.Client') as mock_storage:
            mock_client = Mock()
