...
from gcp_pipeline_beam.file_management.archiver import FileArchiver
...
class TestFileArchiverInit:
    ...
    @patch('gcp_pipeline_beam.file_management.archiver.storage.Client')
...
class TestArchiveFile:
    ...
    def mock_gcs_setup(self):
        ...
        with patch('gcp_pipeline_beam.file_management.archiver.storage.Client') as mock_client:
            client = Mock()
