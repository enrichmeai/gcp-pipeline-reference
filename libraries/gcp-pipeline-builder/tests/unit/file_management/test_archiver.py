...
from gcp_pipeline_builder.file_management.archiver import FileArchiver
...
class TestArchiveFile:
    ...
    def mock_gcs_setup(self):
        ...
        with patch('gcp_pipeline_builder.file_management.archiver.storage.Client') as mock_client:
            client = Mock()
