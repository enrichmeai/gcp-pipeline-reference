...
from gcp_pipeline_builder.orchestration.callbacks.factory import ErrorHandler
...
class TestErrorHandler(unittest.TestCase):
    ...
    @patch('gcp_pipeline_builder.orchestration.callbacks.factory.publish_to_dlq')
    ...
    @patch('gcp_pipeline_builder.orchestration.callbacks.factory.on_failure_callback')
