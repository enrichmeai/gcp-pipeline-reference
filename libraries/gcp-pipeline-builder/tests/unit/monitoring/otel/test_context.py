...
from gcp_pipeline_builder.monitoring.otel import OTELContext, SpanContext
from gcp_pipeline_builder.monitoring.otel.tracing import shutdown_otel
...
class TestOTELContext:
    ...
    def test_base_attributes_set(self):
        ...
        with OTELContext(run_id="run_123", system_id="EM") as ctx:
            ...
            assert ctx._base_attributes["system_id"] == "EM"
