...
# Add the project root to the path so tests can import gcp_pipeline_builder
...
def sample_pipeline_config():
    ...
    from gcp_pipeline_builder.orchestration.routing import PipelineConfig, FileType
