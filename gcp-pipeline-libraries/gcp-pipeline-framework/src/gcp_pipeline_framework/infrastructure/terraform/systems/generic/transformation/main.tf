...
resource "google_bigquery_dataset" "odp_generic" {
  ...
  description   = "Raw data from Generic mainframe extracts (customers, accounts, decision)"
...
resource "google_bigquery_dataset" "fdp_generic" {
  ...
  description   = "Transformed Generic data (event_transaction_excess and portfolio_account_excess)"
  location      = var.bq_location
