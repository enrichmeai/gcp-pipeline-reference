...
def staging_sample_pipeline_run():
    ...
    Example:
        ...
        gcloud composer environments run my-composer-env \\
            ...
            dags trigger -- generic_applications_migration
    ...
    [ ] Monitor DAG execution:
        gcloud composer environments run <env> \\
            --location <region> \\
            dags list-runs -- generic_applications_migration
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Generic Blueprint GCP Deployment Tests")
    parser.add_argument(
        "--phase",
