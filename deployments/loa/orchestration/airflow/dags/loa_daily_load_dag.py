...
def validate_input_files(**context):
    ...
    from deployments.loa.pipeline.dag_template import validate_input_files as _validate
...
def run_quality_checks(**context):
    ...
    from deployments.loa.pipeline.dag_template import run_quality_checks as _quality_checks
    return _quality_checks(output_table=ODP_TABLE, expected_min_rows=1, **context)


def archive_processed_files(**context):
    """Archive processed files."""
    from deployments.loa.pipeline.dag_template import archive_processed_files as _archive
