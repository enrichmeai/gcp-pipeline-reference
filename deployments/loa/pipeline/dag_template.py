...
Usage:
  from deployments.loa.pipeline.dag_template import create_loa_dag
...
def validate_input_files(job_name: str, input_pattern: str, **context) -> Dict[str, Any]:
    ...
    from deployments.loa.pipeline.pipeline_router import PipelineRouter
...
def run_quality_checks(output_table: str, expected_min_rows: int = 100, **context) -> Dict[str, Any]:
    ...
    """
    from gdw_data_core.core import BigQueryClient
...
def archive_processed_files(input_pattern: str, **context) -> Dict[str, Any]:
    ...
    from gdw_data_core.core.file_management import archive_files
