"""
PyTest Configuration and Fixtures for Generic Blueprint Tests
==========================================================

Provides centralized fixtures for:
- Generic entity test data (customers, accounts, decision)
...
# ============================================================================
# Generic CUSTOMER FIXTURES
# ============================================================================

@pytest.fixture
def generic_customer_record():
    """Valid Generic customer record."""
    return {
        "customer_id": "C001",
        "first_name": "John",
        "last_name": "Doe",
...
def generic_customer_records():
    """Multiple Generic customer records for batch testing."""
    return [
        {
            "customer_id": "C001",
            "first_name": "John",
...
# ============================================================================
# Generic ACCOUNT FIXTURES
# ============================================================================

@pytest.fixture
def generic_account_record():
    """Valid Generic account record."""
    return {
        "account_id": "A001",
        "customer_id": "C001",
...
@pytest.fixture
def generic_account_records():
    """Multiple Generic account records for batch testing."""
    return [
        {
            "account_id": "A001",
            "customer_id": "C001",
...
# ============================================================================
# Generic DECISION FIXTURES
# ============================================================================

@pytest.fixture
def generic_decision_record():
    """Valid Generic decision record."""
    return {
        "decision_id": "D001",
        "customer_id": "C001",
...
@pytest.fixture
def generic_decision_records():
    """Multiple Generic decision records for batch testing."""
    return [
        {
            "decision_id": "D001",
            "customer_id": "C001",
...
# ============================================================================
# Generic FILE FIXTURES (with HDR/TRL)
# ============================================================================

@pytest.fixture
def generic_customers_file_lines():
    """Sample Generic customers file with HDR/TRL."""
    return [
        "HDR|Generic|customers|20260101",
...
@pytest.fixture
def generic_accounts_file_lines():
    """Sample Generic accounts file with HDR/TRL."""
    return [
        "HDR|Generic|accounts|20260101",
...
@pytest.fixture
def generic_decision_file_lines():
    """Sample Generic decision file with HDR/TRL."""
    return [
        "HDR|Generic|decision|20260101",
...
def generic_run_id():
    """Sample run ID."""
    return "generic_customers_20260101_103000"


@pytest.fixture(scope="function")
def temp_output_dir() -> Generator[str, None, None]:
    """Create a temporary directory for test outputs."""
    temp_dir = tempfile.mkdtemp(prefix="generic_test_")
    yield temp_dir
    shutil.rmtree(temp_dir, ignore_errors=True)


@pytest.fixture
def temp_csv_file(temp_output_dir, generic_customers_file_lines) -> Generator[str, None, None]:
    """Create a temporary CSV file with Generic customer data."""
    file_path = os.path.join(temp_output_dir, "generic_customers_20260101.csv")
    with open(file_path, 'w', newline='') as f:
        for line in generic_customers_file_lines:
            f.write(line + '\n')
    yield file_path
...
def sample_dag():
    """
    Create a sample Generic Airflow DAG for testing DAG structure and tasks.
    """
    try:
        from data_ingestion.orchestration.airflow.dags.generic_daily_load_dag import dag
        return dag
    except ImportError as e:
        pytest.skip(f"Generic DAG module not available: {str(e)}")
