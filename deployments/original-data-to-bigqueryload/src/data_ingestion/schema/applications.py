...
Entity schema definition for Generic Applications.
"""
...
LOAApplicationsSchema = EntitySchema(
    ...
    description="Generic loan application records containing application, account, event, transaction, and excess information",
