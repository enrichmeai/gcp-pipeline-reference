...
from ..schema import EM_SCHEMAS, get_application1_schema
...
class EMRecordValidator:
    """
    Validates Application1 records using schema-driven validation.
    ...
    def check_duplicates(
        ...
        """
        schema = get_application1_schema(entity_name)
        if not schema:
            return []
