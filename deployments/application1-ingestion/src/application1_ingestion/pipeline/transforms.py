"""
Application1 Pipeline Transforms.

Apache Beam DoFn classes for Application1 entity processing.
...
class ParseAndValidateRecordDoFn(beam.DoFn):
    ...
    def __init__(
        ...
        self.valid_count = beam.metrics.Metrics.counter("application1", "valid_records")
        self.error_count = beam.metrics.Metrics.counter("application1", "error_records")
