"""
Application1 Pipeline Options.

Apache Beam pipeline options for Application1 entity processing.
"""
...
class EMPipelineOptions(PipelineOptions):
    """Application1-specific pipeline options."""
    ...
    def _add_argparse_args(cls, parser):
        parser.add_argument(
            ...
            help='Application1 entity to process'
        )
        parser.add_argument(
            '--input_file',
            type=str,
