"""
PyTest Configuration and Fixtures for Application1 Blueprint Tests
==========================================================

Provides centralized fixtures for:
- Application1 entity test data (customers, accounts, decision)
...
# ============================================================================
# Application1 CUSTOMER FIXTURES
# ============================================================================

@pytest.fixture
def application1_customer_record():
    """Valid Application1 customer record."""
    return {
        "customer_id": "C001",
        "first_name": "John",
        "last_name": "Doe",
...
@pytest.fixture
def application1_customer_records():
    """Multiple Application1 customer records for batch testing."""
    return [
        {
            "customer_id": "C001",
            "first_name": "John",
...
# ============================================================================
# Application1 ACCOUNT FIXTURES
# ============================================================================

@pytest.fixture
def application1_account_record():
    """Valid Application1 account record."""
    return {
        "account_id": "A001",
        "customer_id": "C001",
...
@pytest.fixture
def application1_account_records():
    """Multiple Application1 account records for batch testing."""
    return [
        {
            "account_id": "A001",
            "customer_id": "C001",
...
# ============================================================================
# Application1 DECISION FIXTURES
# ============================================================================

@pytest.fixture
def application1_decision_record():
    """Valid Application1 decision record."""
    return {
        "decision_id": "D001",
        "customer_id": "C001",
...
@pytest.fixture
def application1_decision_records():
    """Multiple Application1 decision records for batch testing."""
    return [
        {
            "decision_id": "D001",
            "customer_id": "C001",
...
# ============================================================================
# Application1 FILE FIXTURES (with HDR/TRL)
# ============================================================================

@pytest.fixture
def application1_customers_file_lines():
    """Sample Application1 customers file with HDR/TRL."""
    return [
        "HDR|Application1|customers|20260101",
...
@pytest.fixture
def application1_accounts_file_lines():
    """Sample Application1 accounts file with HDR/TRL."""
    return [
        "HDR|Application1|accounts|20260101",
...
@pytest.fixture
def application1_decision_file_lines():
    """Sample Application1 decision file with HDR/TRL."""
    return [
        "HDR|Application1|decision|20260101",
...
@pytest.fixture
def application1_extract_date():
    """Sample extract date."""
    return date(2026, 1, 1)


@pytest.fixture
def application1_run_id():
    """Sample run ID."""
    return "application1_customers_20260101_103000"


@pytest.fixture(scope="function")
def temp_output_dir() -> Generator[str, None, None]:
    """Create a temporary directory for test outputs."""
    temp_dir = tempfile.mkdtemp(prefix="application1_test_")
    yield temp_dir
    shutil.rmtree(temp_dir, ignore_errors=True)


@pytest.fixture
def temp_csv_file(temp_output_dir, application1_customers_file_lines) -> Generator[str, None, None]:
    """Create a temporary CSV file with Application1 customer data."""
    file_path = os.path.join(temp_output_dir, "application1_customers_20260101.csv")
    with open(file_path, 'w', newline='') as f:
        for line in application1_customers_file_lines:
            f.write(line + '\n')
    yield file_path
...
def sample_dag():
    """
    Create a sample Application1 Airflow DAG for testing DAG structure and tasks.
    """
    try:
        from application1_ingestion.orchestration.airflow.dags.application1_daily_load_dag import dag
        return dag
    except ImportError as e:
        pytest.skip(f"Application1 DAG module not available: {str(e)}")
