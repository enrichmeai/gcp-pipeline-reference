"""Unit tests for deployments.application1.config module."""

import pytest

from application1_ingestion.config import (
    # Settings
    SYSTEM_ID,
    REQUIRED_ENTITIES,
    ODP_DATASET,
...
class TestSettings:
    """Tests for deployments.application1.config.settings module."""

    def test_system_id(self):
        """System ID should be Application1."""
        assert SYSTEM_ID == "Application1"

    def test_required_entities(self):
        """Required entities should include all 3 Application1 entities."""
...
class TestConstants:
    """Tests for deployments.application1.config.constants module."""
