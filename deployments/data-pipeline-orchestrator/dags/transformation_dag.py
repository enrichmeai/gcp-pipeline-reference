...
def verify_all_entities_loaded(**context) -> str:
    """
    Verify all 3 Generic entities are loaded before running transformation.
...
with DAG(
    ...
    description='Transform Generic ODP to FDP (event_transaction_excess and portfolio_account_excess)',
