"""
Application2 Pipeline Transforms.

Apache Beam DoFn classes for Application2 entity processing.
...
class ParseAndValidateRecordDoFn(beam.DoFn):
    ...
    def __init__(
        ...
        # Metrics
        self.valid_count = beam.metrics.Metrics.counter("application2", "valid_records")
        self.error_count = beam.metrics.Metrics.counter("application2", "error_records")
