"""
Application2 Applications Entity Schema.

Entity schema definition for Application2 Applications.
"""
...
LOAApplicationsSchema = EntitySchema(
    ...
    description="Application2 loan application records containing application, account, event, transaction, and excess information",
