"""
PyTest Configuration and Fixtures for Application2 Tests
=================================================

Provides centralized fixtures for:
- Application2 entity test data (applications)
...
# ============================================================================
# Application2 APPLICATION FIXTURES
# ============================================================================

@pytest.fixture
def application2_application_record():
    """Valid Application2 application record."""
    return {
...
@pytest.fixture
def application2_application_records():
    """Multiple Application2 application records for batch testing."""
    return [
        {
            "application_id": "APP001",
            "customer_id": "CUST001",
...
@pytest.fixture
def application2_invalid_application_record():
    """Invalid Application2 application record for error testing."""
    return {
...
@pytest.fixture
def application2_applications_file_lines():
    """Sample Application2 applications file with HDR/TRL."""
    return [
        "HDR|Application2|Applications|20260101",
...
@pytest.fixture
def application2_applications_file_lines_invalid_header():
    """Sample Application2 file with invalid header."""
    return [
...
@pytest.fixture
def application2_applications_file_lines_missing_trailer():
    """Sample Application2 file missing trailer."""
    return [
        "HDR|Application2|Applications|20260101",
        "application_id,customer_id,application_date",
        "APP001,CUST001,2026-01-01",
...
@pytest.fixture
def application2_extract_date():
    """Sample extract date."""
    return date(2026, 1, 1)


@pytest.fixture
def application2_run_id():
    """Sample run ID."""
    return f"application2_applications_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
...
def mock_gcs_client():
    ...
    mock = MagicMock()
    mock.list_files.return_value = ["application2_applications_20260101.csv"]
    mock.read_file.return_value = "HDR|Application2|Applications|20260101\n..."
    return mock
...
def temp_data_dir(tmp_path):
    """Create temporary directory with sample Application2 data files."""
    data_dir = tmp_path / "application2_data"
    data_dir.mkdir()

    # Create sample applications file
    apps_file = data_dir / "application2_applications_20260101.csv"
    apps_content = """HDR|Application2|Applications|20260101
...
TRL|RecordCount=3|Checksum=abc123"""
    ...
    # Create .ok file
    ok_file = data_dir / "application2_applications_20260101.csv.ok"
    ok_file.write_text("")
...
@pytest.fixture
def application2_schema():
    """Get Application2 applications schema."""
    from application2_ingestion.schema import LOAApplicationsSchema
    return LOAApplicationsSchema


@pytest.fixture
def application2_domain_schema():
    """Get Application2 BigQuery schema."""
    from application2_ingestion.domain.schema import ODP_APPLICATIONS_SCHEMA
...
@pytest.fixture
def application2_validator():
    """Create Application2 validator instance."""
    from application2_ingestion.validation import LOAValidator
    return LOAValidator()


@pytest.fixture
def application2_file_validator():
    """Create Application2 file validator instance."""
    from application2_ingestion.validation import LOAFileValidator
    return LOAFileValidator()


@pytest.fixture
def application2_record_validator():
    """Create Application2 record validator instance."""
    from application2_ingestion.validation import LOARecordValidator
