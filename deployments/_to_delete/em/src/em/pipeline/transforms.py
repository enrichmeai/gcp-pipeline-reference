"""
EM Pipeline Transforms.

Apache Beam DoFn classes for EM entity processing.
...
class ParseAndValidateRecordDoFn(beam.DoFn):
    ...
    def __init__(
        ...
        self.valid_count = beam.metrics.Metrics.counter("em", "valid_records")
        self.error_count = beam.metrics.Metrics.counter("em", "error_records")
