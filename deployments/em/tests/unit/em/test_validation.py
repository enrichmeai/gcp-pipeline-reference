"""Unit tests for EM validation module."""

import pytest
from datetime import date
from typing import Dict, List, Any

from deployments.em.validation.file_validator import EMFileValidator
from deployments.em.validation.record_validator import EMRecordValidator
from deployments.em.validation.validator import EMValidator
from deployments.em.validation.types import ValidationResult


class TestEMFileValidator:
    """Tests for EM file validation."""
...
class TestEMValidator:
    """Tests for unified EM validator."""
