...
class TestValidationPipeline:
    ...
    def test_error_record_structure(self, temp_csv_file):
        ...
        from blueprint.em.components.loa_domain.validation import validate_application_record
        from blueprint.em.components.loa_domain.schema import validation_error_to_bq_row
...
class TestSchemaDefinitions:
    ...
    def test_applications_raw_schema(self):
        ...
        from blueprint.em.components.loa_domain.schema import APPLICATIONS_RAW_SCHEMA, get_field_names
    ...
    def test_record_to_bq_conversion(self):
        ...
        from blueprint.em.components.loa_domain.schema import record_to_bq_compatible
...
class TestBeamPipelineStructure:
    ...
    def test_parse_csv_dofn(self):
        ...
        from blueprint.em.components.loa_pipelines.loa_jcl_template import ParseCsvLine
    ...
    def test_validate_record_dofn(self):
        ...
        from blueprint.em.components.loa_pipelines.loa_jcl_template import validate_application_fn
