...
Main entry point for EM Dataflow pipeline.
"""
...
def run_pipeline(argv=None):
    ...
    em_options = pipeline_options.view_as(EMPipelineOptions)

    entity = em_options.entity
    input_file = em_options.input_file
    output_table = em_options.output_table
    error_table = em_options.error_table
    ...
    logger.info(f"Starting EM pipeline for {entity}")
    ...
    logger.info(f"EM pipeline completed for {entity}")
