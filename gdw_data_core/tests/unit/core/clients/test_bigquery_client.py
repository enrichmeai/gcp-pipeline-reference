...
Tests mirror source: gdw_data_core/core/clients/bigquery_client.py
...
def _reload_bigquery_client():
    ...
    for mod in list(sys.modules.keys()):
        if 'bigquery_client' in mod or 'gdw_data_core.core.clients' == mod:
            del sys.modules[mod]
    from gdw_data_core.core.clients.bigquery_client import BigQueryClient
...
class TestBigQueryClientInit:
    ...
    def test_initialization(self):
        ...
        with patch('gdw_data_core.core.clients.bigquery_client.bigquery.Client'):
...
class TestBigQueryClientWriteTable:
    ...
    def test_write_to_table_success(self):
        ...
        with patch('gdw_data_core.core.clients.bigquery_client.bigquery.Client') as mock_bq:
            BigQueryClient = _reload_bigquery_client()
            client = BigQueryClient(project='test-project', dataset='test_dataset')
