...
def mock_storage_client():
    ...
    with patch('gdw_data_core.core.clients.gcs_client.storage.Client') as mock_client:
...
def mock_pubsub_publisher():
    ...
    with patch('gdw_data_core.core.clients.pubsub_client.pubsub_v1.PublisherClient') as mock_client:
        mock_instance = MagicMock()
        mock_client.return_value = mock_instance
        yield mock_instance
