...
from gdw_data_core.core.file_management.validator import FileValidator
...
class TestValidateFileExists:
    ...
    def validator_with_mocks(self):
        ...
        with patch('gdw_data_core.core.file_management.validator.storage.Client') as mock_storage:
            mock_client = Mock()
