# 📊 LOA Blueprint - Data Quality Standards (Hybrid Library & Dataplex)
...
The platform utilizes a **hybrid data quality strategy** to ensure data trust. We combine the fine-grained control of our internal **`gdw_data_core` Python library** with the managed scale and profiling capabilities of **Google Cloud Dataplex**.
...
### 1. Library-Based Checks (`gdw_data_core`)
...
Pipelines should integrate quality checks using the `gdw_data_core` library wrapper to ensure unified reporting.
...
- [GDW Data Core: Data Quality Module](../../gdw_data_core/core/data_quality/)
